...
def calculate_match(recipe_ingredients, allergy_array):
    ...
    dairy = ["milk", "cheese", "yogurt", "chocolate milk", "butter", "buttermilk", "Cottage cheese", "curd", "custard", "Dulce de Leche", "Frozen yogurt", 
    "Gelato", "Ice cream", "Paneer", "Whipped Cream", "Pizza"]
    egg = ["egg","eggs"]
    ...
    seafood = ["fish", "shrimp", "salmon", "catfish", "lobster", "crab", "tilapia", "oyster", "anchovy"] 
    sesame = ["sesame"]
    soy = ["soy","soymilk"]
