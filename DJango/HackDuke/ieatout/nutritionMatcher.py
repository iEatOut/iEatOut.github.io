...
#anti_search_terms.append("&nutrition.NA.min=101")
#anti_search_terms.append("&nutrition.CHOLE.min=11")
#anti_search_terms.append("&nutrition.SUGAR.min=1")
#anti_search_terms.append("&nutrition.PROCNT.max=9")
#anti_search_terms.append("&nutrition.CHOCDF.min=11")
#anti_search_terms.append("&nutrition.FIBTG.max=1")
